...
//   qwen38  -> Qwen3.8-27B on NInfer engine :8084 (~90 t/s, 131K)  — strongest local coder
...
export type ComposerProfile = 'local35' | 'coder' | 'fast' | 'gptoss' | 'glm47' | 'gemma4' | 'qwen38' | 'remote';
...
export const LOCAL_SWAP_PROFILES: ComposerProfile[] = ['local35', 'coder', 'fast', 'gptoss', 'glm47', 'gemma4', 'qwen38'];

export function isComposerProfile(v: unknown): v is ComposerProfile {
  return v === 'local35' || v === 'coder' || v === 'fast' || v === 'gptoss' || v === 'glm47' || v === 'gemma4' || v === 'qwen38' || v === 'remote';
}
