param(
    ...
    [string]$VllmBaseUrl = "http://127.0.0.1:8086/v1",
...
$results += Invoke-OpenAiBenchmark -Name "vllm-int4-mtp:8086" -BaseUrl $VllmBaseUrl -Model "qwen3.6-27b-vllm"
$results += Invoke-OpenAiBenchmark -Name "wsl-rotorquant-35b-a3b:8085" -BaseUrl $RotorQuantBaseUrl -Model "qwen3.6-35b-a3b-rotorquant"
